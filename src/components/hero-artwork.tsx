  ...
  return (
    <div className="hero-artwork" aria-hidden="true">
      <svg viewBox="0 0 1440 360" fill="none" focusable="false">
        <g stroke="#cfd9e7" strokeWidth="0.8">
        ...
        <circle cx="270" cy="158" r="4.5" fill="#0066cc" />
        <circle cx="1108" cy="170" r="4.5" fill="#0066cc" />
        {layers && (
          <g stroke="#b8c8dc" strokeWidth="0.9" strokeLinejoin="round">
            <path d="m1140 225 110-57 110 57-110 58-110-58Z" fill="#f8fbff" />
            <path
              d="m1140 225 110 58 110-58v11l-110 58-110-58v-11Z"
              fill="#eef4fc"
            />
            <path d="m1140 187 110-57 110 57-110 58-110-58Z" fill="#fbfdff" />
            <path
              d="m1140 187 110 58 110-58v11l-110 58-110-58v-11Z"
              fill="#eef4fc"
            />
            <path d="m1140 149 110-57 110 57-110 58-110-58Z" fill="#ffffff" />
            <path
            ...
            <path
              ...
              stroke="none"
            />
            <circle cx="1250" cy="149" r="2.5" fill="#0066cc" stroke="none" />
          </g>
        )}
      </svg>
    </div>
